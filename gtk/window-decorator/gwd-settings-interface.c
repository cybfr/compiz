...
const gchar   *METACITY_THEME_DEFAULT = "Clearlooks";
...
const gchar *  METACITY_BUTTON_LAYOUT_DEFAULT = "menu:minimize,maximize,close";
...
const gchar * TITLEBAR_FONT_DEFAULT = "Sans 10";
